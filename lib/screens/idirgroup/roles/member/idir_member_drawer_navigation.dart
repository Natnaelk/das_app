...
import 'package:das_app/screens/idirgroup/roles/member/components/leave_page.dart';
...
class idirMemberDrawer extends StatefulWidget {
  String idir;
  List members;

  idirMemberDrawer({this.idir, this.members});

  @override
  State<idirMemberDrawer> createState() => _idirMemberDrawerState();
}

class _idirMemberDrawerState extends State<idirMemberDrawer> {
  @override
  @override
...
void SelectedItem(BuildContext context, int index, String idir, List members) {
  ...
  switch (index) {
    ...
    case 1:
      Navigator.of(context).pushReplacement(MaterialPageRoute(
          builder: (context) =>
              ViewMembersPage(idirId: idir, members: members)));
      break;

    case 2:
      Navigator.of(context).pushReplacement(MaterialPageRoute(
          builder: (context) =>
              IdirMemberpaymentPage(idirId: idir, members: members)));
      break;

    case 3:
      Navigator.of(context).pushReplacement(MaterialPageRoute(
          builder: (context) =>
              MemberLeavePage(idirId: idir, members: members)));
      break;
  }
}
